...
-- ============================================
-- 13. NUTRITION ASSESSMENT IN USER PROFILES
-- ============================================
ALTER TABLE user_profiles
ADD COLUMN IF NOT EXISTS nutrition_assessment JSONB;
...
CREATE TABLE IF NOT EXISTS chat_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  title TEXT DEFAULT 'محادثة مع ملهم',
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- AUTO-UPDATE TIMESTAMPS for chat_sessions
...
-- ============================================
-- RLS POLICY: meal_plans UPDATE (needed for completed_meals sync)
-- ============================================
