...
export default function PlanScreen() {
  ...
  const { generateWeeklyPlan: generatePlan, regenerateSession } = useWorkoutPlanGenerator({ profile, t, language });
            ...
            <ScrollView style={styles.addExerciseScroll}>
              ...
              <View style={styles.addExerciseSection}>
                ...
                {Object.entries(exerciseDatabase).map(([muscleGroup, exercises]) => {
                  ...
                  let filteredExercises = profile?.trainingLocation
                    ? filterExercisesByLocation(exercises, profile.trainingLocation)
                    : exercises;
